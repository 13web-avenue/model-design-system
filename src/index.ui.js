...
import VTimelineSetup from '../components/ui/defaults/v-timeline/v-timeline-setup.md'

import VTextfield from '../components/ui/defaults/v-textfield/packages/dist/v-textfield.vue'
import VTextfieldChangelog from '../components/ui/defaults/v-textfield/v-textfield-changelog.md'
import VTextfieldSetup from '../components/ui/defaults/v-textfield/v-textfield-setup.md'

import VTextarea from '../components/ui/defaults/v-textarea/packages/dist/v-textarea.vue'
import VTextareaChangelog from '../components/ui/defaults/v-textarea/v-textarea-changelog.md'
import VTextareaSetup from '../components/ui/defaults/v-textarea/v-textarea-setup.md'

import VSnackbar from '../components/ui/defaults/v-snackbar/packages/dist/v-snackbar.vue'
import VSnackbarChangelog from '../components/ui/defaults/v-snackbar/v-snackbar-changelog.md'
import VSnackbarSetup from '../components/ui/defaults/v-snackbar/v-snackbar-setup.md'

import VSearch from '../components/ui/defaults/v-search/packages/dist/v-search.vue'
import VSearchChangelog from '../components/ui/defaults/v-search/v-search-changelog.md'
import VSearchSetup from '../components/ui/defaults/v-search/v-search-setup.md'

import VRatings from '../components/ui/defaults/v-ratings/packages/dist/v-ratings.vue'
...
import VExpansionPanel from '../components/ui/defaults/v-expansion-panel/packages/dist/v-expansion-panel.vue'
import VExpansionPanelChangelog from '../components/ui/defaults/v-expansion-panel/v-expansion-panel-changelog.md'
import VExpansionPanelSetup from '../components/ui/defaults/v-expansion-panel/v-expansion-panel-setup.md'

import VDivider from '../components/ui/defaults/v-divider/packages/dist/v-divider.vue'
import VDividerChangelog from '../components/ui/defaults/v-divider/v-divider-changelog.md'
import VDividerSetup from '../components/ui/defaults/v-divider/v-divider-setup.md'

import VDatatable from '../components/ui/defaults/v-data-table/packages/dist/v-datatable.vue'
import VDatatableChangelog from '../components/ui/defaults/v-data-table/v-datatable-changelog.md'
import VDatatableSetup from '../components/ui/defaults/v-data-table/v-datatable-setup.md'
...
import VCardSetup from '../components/ui/defaults/v-card/v-card-setup.md'

import VBreadcrumbs from '../components/ui/defaults/v-breadcrumbs/packages/dist/v-breadcrumbs.vue'
import VBreadcrumbsChangelog from '../components/ui/defaults/v-breadcrumbs/v-breadcrumbs-changelog.md'
import VBreadcrumbsSetup from '../components/ui/defaults/v-breadcrumbs/v-breadcrumbs-setup.md'

import VBadge from '../components/ui/defaults/v-badge/packages/dist/v-badge.vue'
import VBadgeChangelog from '../components/ui/defaults/v-badge/v-badge-changelog.md'
import VBadgeSetup from '../components/ui/defaults/v-badge/v-badge-setup.md'

import VAlert from '../components/ui/defaults/v-alert/packages/dist/v-alert.vue'
import VAlertChangelog from '../components/ui/defaults/v-alert/v-alert-changelog.md'
import VAlertSetup from '../components/ui/defaults/v-alert/v-alert-setup.md'
